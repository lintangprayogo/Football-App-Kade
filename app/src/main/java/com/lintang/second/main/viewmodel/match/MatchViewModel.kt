...
class MatchViewModel(val context: Application, private val repository: Repository) :
    BaseViewModel(context) {
    var matchListLive = SingleLiveEvent<List<SingleMatch>>()


    fun getMatch(idLeague: String) {
        repository.getNextMatch(idLeague, object : DataSource.GetRemoteCallback<List<SingleMatch>> {
